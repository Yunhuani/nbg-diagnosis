...
def test_mark_finance_basic_degradation_when_cash_runway_is_unavailable():
    ...
    assert "ç°é‡‘å®‰å…¨è¾¹é™…å·²æŒ‰å½“å‰ç»è¥ä¿¡æ¯åšç»“æ„æ€§åˆ¤æ–­" in degradation["upgrade_hook"]
    assert "è¿›ä¸€æ­¥é‡åŒ–ç°é‡‘è·‘é“å’Œå®‰å…¨å«" in degradation["upgrade_hook"]
...
def test_run_diagnosis_completes_and_marks_finance_degraded_for_null_basic_finance(
    ...
    assert (
        "ç°é‡‘å®‰å…¨è¾¹é™…å·²æŒ‰å½“å‰ç»è¥ä¿¡æ¯åšç»“æ„æ€§åˆ¤æ–­"
